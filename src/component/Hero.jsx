...
const Hero = () => {
  return (
    <section>
      <div className="dark:bg-violet-400 bg-violet-400">
        <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
          ...
          <div className="flex flex-wrap justify-center">
            <button
              type="button"
              className="px-8 py-3 m-2 text-lg font-semibold rounded dark:bg-gray-800 bg-gray-800 text-gray-50 dark:text-gray-50"
            >
              Get started
            </button>
            <button
      ...
      {/* <img
        src="https://source.unsplash.com/random/auto"
        alt=""
        className="hidden sm:block w-5/6 mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40 h-56 dark:bg-gray-500"
      /> */}
    </section>
  );
};
